...
export function RecipeCreate() {
    const [ingredientId, setIngredientIds] = useState([]);
    ...
    return (
        <div className='card p-3'>
            ...
            >
                ...
                <div className="form-group row pb-3 border-bottom">
                    <label htmlFor="" className='col-sm-2 col-form-label'>Hozzávalók</label>
                    {ingredientId.map((ingredientId, i) => (
                                    ...
                                    <div className="w-100">
                                        <button className="btn btn-danger mb-3" type="button" onClick={() => {
                                            setIngredientIds((prevIds) => {
                                                const ret = [...prevIds];
                                                ret.splice(
                                                    prevIds.findIndex((id) => id === ingredientId), 1);
                                                return ret;
                                            })
                                        }}>
...
export function ShakeNespresso() {
    return (
        <div>What else?</div>
    )
}
